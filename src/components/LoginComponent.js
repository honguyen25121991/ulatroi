...
class Login extends React.Component {
  ...
  handleLogin = () => {
    console.log("first");
    <Link to={this.state.current} onClick={this.handleClick}>
      Login
    </Link>;
  };
    ...
    return (
      ...
      >
        <Header
          ...
          style={{ background: "none", border: 0, marginTop: 20 }}
        >
          <Menu
            height={40}
          ...
          <Row gutter={[24, 8]}>
                ...
                <Row gutter={[10, 10]}>
                  <Col className="gutter-row" span={4}>
                    <Image
                      ...
                      src="https://images.vexels.com/media/users/3/145922/raw/eb6591b54b2b6462b4c22ec1fc4c36ea-female-avatar-maker.jpg"
                    />
                  </Col>
                  <Col className="gutter-row" span={4}>
                    <Image
            ...
            <Col className="gutter-row" span={7}>
              <div style={{ marginTop: 50, padding: 20, height: 600 }}>
                <Card
                  bordered={false}
                  style={{ borderRadius: 30, height: 370 }}
                >
                  <Typography
                    style={{
                      fontSize: 20,
                  ...
                  <div
                    style={{ fontSize: 15, marginTop: 50, fontWeight: "bold" }}
                  >
                    Dont'have account?{" "}
                    <a style={{ color: "#a52729", fontWeight: "bold" }}>
                      Register
                    </a>
                  </div>
                </Card>
